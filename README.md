...
This is a fork of CodeRabbit that has been rebranded as NerdShark.
...
NerdShark `ai-pr-reviewer` is an AI-based code reviewer and summarizer for
...
- [Overview](#overview)
- [Professional Version of NerdShark](#professional-version-of-nerdshark)
- [Reviewer Features](#reviewer-features)
- [Install instructions](#install-instructions)
- [Conversation with NerdShark](#conversation-with-nerdshark)
- [Examples](#examples)
...
jobs:
  review:
    ...
    steps:
      - uses: nerdshark/ai-pr-reviewer@latest
        env:
...
system_message: |
  ...
  Company context -
  NerdShark is an AI-powered Code reviewer. It boosts code quality and cuts manual effort. Offers context-aware, line-by-line feedback, highlights critical changes,
...
## Conversation with NerdShark

You can reply to a review comment made by this action and get a response based
on the diff context. Additionally, you can invite the bot to a conversation by
tagging it in the comment (`@nerdshark`).

Example:

> @nerdshark Please generate a test plan for this file.
